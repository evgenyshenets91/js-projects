...
const completeSVG = '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 22 22" style="enable-background:new 0 0 22 22;" xml:space="preserve"><style type="text/css">.st0{fill:none;}.st1{fill:#26B999;}</style><rect y="0" class="st0" width="22" height="22"/><g><path class="fill" d="M9.7,14.4L9.7,14.4c-0.2,0-0.4-0.1-0.5-0.2l-2.7-2.7c-0.3-0.3-0.3-0.8,0-1.1s0.8-0.3,1.1,0l2.1,2.1l4.8-4.8c0.3-0.3,0.8-0.3,1.1,0s0.3,0.8,0,1.1l-5.3,5.3C10.1,14.3,9.9,14.4,9.7,14.4z"/></g></svg>';
...
function removeItem () {
  ...
  let delElem = this.parentNode.parentNode;
  // родетель li -> ul
  let parent = delElem.parentNode; 
...
function completeItem () {
  let choiceElem =   this.parentNode.parentNode; // li
  let parent = choiceElem.parentNode; // ul
  
  let target ; // определяем родителя, куда будем перемещать элемент
